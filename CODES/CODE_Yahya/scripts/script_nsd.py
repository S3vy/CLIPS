...
def assessSegmentation(gt_nii_path,tmtv_seg_path,patient_dicom,tolerance_mm,suv_threshold=4,percentile_hausdorff=100): 
    a=gt_nii_path
    b=tmtv_seg_path
    ...
    lesionwise_metric=lesionwise_nsd(data_lesions[0],data_lesions[1],data_lesions[2],data_lesions[3],data[2], tolerance_mm) 
    ...
    nb_tp_global=len(tp_global_identifier_nsd(data_lesions[0],data_lesions[1],lesionwise_metric[0],data[2], tolerance_mm,threshold=lesionwise_threshold))
    nb_fn_global=len(fn_global_identifier_nsd(data_lesions[0],data_lesions[1],lesionwise_metric[0],data[2], tolerance_mm,threshold=lesionwise_threshold))
    nb_fp_global=len(fp_global_identifier_nsd(data_lesions[0],data_lesions[1],lesionwise_metric[1],data[2], tolerance_mm,threshold=lesionwise_threshold))
